# BAM! Engine
BAM! Engine is a game engine buit entirely (well, there is a bit of .json, HTML & CSS) in Python, and is very good for the development of 2D games, that aren't labour-intensive. Unlike Unity,
